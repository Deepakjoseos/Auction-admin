...
const LotteryGroup = (props) => {
  ...
  return (
    <Switch>
      <Redirect exact from={`${match.url}`} to={`${match.url}/lottery-group-list`} />
     <Route path={`${match.url}/add-lottery-group`} component={AddLotteryGroup} />
      <Route path={`${match.url}/edit-lottery-group/:id`} component={EditLotteryGroup} />
      <Route path={`${match.url}/lottery-group-list`} component={LotteryGroupList} /> 
