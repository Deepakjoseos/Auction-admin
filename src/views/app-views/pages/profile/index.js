            ...
            <Row gutter="10">
              ...
              <Col xs={24} sm={24} md={8}>
                <Row className="mb-2 mt-2 mt-md-0 ">
                  <Col xs={12} sm={12} md={9}>
                    <Icon
                      type={AccountBookOutlined}
                      className="text-primary font-size-md"
                    />
                    <span className="text-muted ml-2">Auth Type:</span>
                  </Col>
                  <Col xs={12} sm={12} md={15}>
                    <span className="font-weight-semibold">
                      {userInfo.authType}
                  ...
                  <Row className="mb-2">
                    <Col xs={12} sm={12} md={9}>
                      <Icon
                        ...
                        className="text-primary font-size-md"
                      />
                      <span className="text-muted ml-2">Employee Type:</span>
                    </Col>
                    <Col xs={12} sm={12} md={15}>
                      <span className="font-weight-semibold">
                        {userInfo.employeeType}
    ...
    <Card title="User Roles">
      {roles.map((role) => (
        <Space
          ...
          align="baseline"
        >
          <Input disabled placeholder={role.module} />

          <Checkbox disabled defaultChecked={role.add}>
            Add
          </Checkbox>
          <Checkbox disabled defaultChecked={role.edit}>
            Edit
          </Checkbox>
          <Checkbox disabled defaultChecked={role.delete}>
            Delete
          </Checkbox>
          <Checkbox disabled defaultChecked={role.fetch}>
            Fetch
          </Checkbox>
        </Space>
      ))}
