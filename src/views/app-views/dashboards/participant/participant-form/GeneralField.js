        ...
        <Row gutter={16}>
            <Col xs={24} sm={24} md={17}>
                <Card title="Basic Info">
                    ...
                    <Form.Item name="gst" label="GST Number" rules={rules.gst}>
                ...
                >
                  <Select placeholder="Relationship Manager">
                    {
                      subAdmins.map(
                        (subAdmin) => <Option value={subAdmin.id}>{subAdmin.name}</Option>
                      )}
                  </Select>
                </Form.Item>
                    <Form.Item
                    ...
                    <Form.Item name="buyerEligibleBuisness" label="Buyer Eligible business type" rules={rules.buyerEligibleBuisness}> 
                    <Input placeholder='Buyer Eligible business type'/>
                    </Form.Item>
                    <Form.Item name="participantClient" label="Participant Client" rules={rules.participantClient}> 
                ...
                <Card title="Contact Person">
                    ...
                    <Form.Item name="contact_person_phone" label="Phone" rules={rules.phone}>
                        <Input placeholder='phone'/>
                    </Form.Item>

                </Card>
                <Card title="Permanent Address">
                    <Form.Item name="permanent_address" label="Address" rules={rules.address}>
                        <Input placeholder='address'/>
                    </Form.Item>
                    <Form.Item name="permanent_city" label="City" rules={rules.city}>
                        <Input placeholder='City'/>
                    </Form.Item>
                    <Form.Item name="permanent_pincode" label="Pincode" rules={rules.pincode}>
                ...
                <Card title="Office Address">
                    <Form.Item name="office_address" label="Address" rules={rules.address}>
                        <Input placeholder='Address'/>
                    </Form.Item>
                    <Form.Item name="office_city" label="City" rules={rules.city}>
                        <Input placeholder='City'/>
                    </Form.Item>
                    <Form.Item name="office_pincode" label="Pincode" rules={rules.pincode}>
                        <Input placeholder='Pincode'/>
                    </Form.Item>
