...
import {
    ...
    Button,
    Image,
    Tag, DatePicker, Table, Menu, Modal, List
} from 'antd'
import {
    EyeOutlined,
    DeleteOutlined,
            ...
            {wallet ?
                ...
                <List>
                    ...
                    <List.Item>
                        ...
                        <Card title="Initial Buying Limit">{wallet?.initialBuyingLimit}</Card>
            ...
            <Row gutter={16}>
                <Col xs={24} sm={24} md={30}>
                    <Card title="Basic Info">
                        ...
                        <Button type="primary" htmlType='button' style={{ float: "right" }} onClick={onFinish}>Update</Button>
